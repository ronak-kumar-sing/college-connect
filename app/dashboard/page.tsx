...
export default function DashboardPage({
  ...
  const handleContact = (room: Room) => {
    ...
    // Handle contact functionality - could implement a contact API or modal
    console.log('Contact owner for room:', room.id, 'by user:', user.userId)
    // You could implement a contact modal, direct messaging, or redirect to a contact page
  }
  ...
  const handleFavorite = async (roomId: string) => {
    ...
    console.log('handleFavorite called with roomId:', roomId)

    if (!roomId) {
      console.error('handleFavorite: roomId is undefined or null')
      return
    }
