...
import { FloatingWebSocketIndicator } from '@/components/debug/FloatingWebSocketIndicator'
...
export default function MessagesPage() {
  ...
  const handleSendMessage = async (content: string, messageType: 'text' | 'image' | 'file' = 'text') => {
    if (!selectedConversation || !user || sending || selectedConversation.isBlocked) return
    ...
    return (
      <div className="h-screen flex flex-col bg-white">
        ...
        <ChatInput
          ...
          disabled={sending || !isConnected || selectedConversation?.isBlocked}
